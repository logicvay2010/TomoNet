...
def deconv_one(tomo, out_tomo, isonet_folder="IsoNet", voltage=300.0, cs=2.7, defocus=1.0, pixel_size=1.0,snrfalloff=1.0, deconvstrength=1.0,highpassnyquist=0.02,chunk_size=200,overlap_rate = 0.25,ncpu=4):
    import mrcfile
